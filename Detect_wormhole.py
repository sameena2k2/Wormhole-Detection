...
def find_wormhole(connectivity_graph_with_wormhole, root_nodes, threshold, endpoints, make_plot=True):
...
def get_arguments():
    ...
    parser.add_argument('--deployment_type', help='Deployment model. Possible choices: "grid" and "random".',
                        choices=['grid', 'random'], default='grid')
    ...
    parser.add_argument('--make_plot', help='True/False for visualization.', type=bool, default=True)
